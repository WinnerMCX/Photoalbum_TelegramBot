...
def send_photo(msg):
    ...
    if hmmims / 15 == 1 or hmmims / 15 == 2 or hmmims / 15 == 3 or hmmims / 15 == 4 or hmmims / 15 == 5 or hmmims / 15 == 6 or hmmims / 15 == 7 or hmmims / 15 == 8 or hmmims / 15 == 9 or hmmims / 15 == 10:
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        markup.add(types.KeyboardButton('Рандом фото'))
...
def any_message(msg):
    messages_storage.append(msg.text)
    print(messages_storage)
    if msg.text == 'пидр' or msg.text == 'Пидр' or msg.text == 'ты пидр' or msg.text == 'Ты пидр':
